...
| Fake (tests + P11 local) | — | [`src/exchange/fake`](../../src/exchange/fake/) |

Each venue doc includes **Manual WebSocket connect** (`wscat` / `websocat`) for live smoke without running HHLD.

Shared contract: [`src/exchange/exchange.go`](../../src/exchange/exchange.go). Architecture: [architect.md](../architect.md). Roadmap phase notes: [p8.md](../roadmap/p8.md), [p9.md](../roadmap/p9.md), [p11.md](../roadmap/p11.md).

...
| [`exchange`](../src/exchange/) / [`fake`](../src/exchange/fake/) | Types + fake venue | ≥ 80% | pass |
...
| Live HL/GRVT tick/book WS | _(P8)_ | Smoke subscribe + normalize to `Book`/`Tick` | pending |
...
| Live adapter book/tick smoke | HL/GRVT WS normalize (P8) | pending |
